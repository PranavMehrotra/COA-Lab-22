...
main:                                                                                           # Main starts
    ...
    beq $s1,$t2,fir                                                                             # If k==1, then print 'st'
    addi $t2,$t2,1
    beq $s1,$t2,sec                                                                             # If k==2, then print 'nd'
    addi $t2,$t2,1
    beq $s1,$t2,thi                                                                             # If k==3, then print 'rd'
    bgt $s1,$t2,genth                                                                           # if k>3, print 'th'
    j end
...
fir:                                                                                            # Output suffix for k if k == 1
    ...
    li $v0,4
    syscall
    jal find_k_largest                                                                          # Call find_k_largest, to print kth largest element
    j end
